/**
 * CRC32 vector test.
 *   crc32-vectors.c (8 September 2021)
 *
...
#define DIGESTLEN     (CRC32LEN)
#define DIGESTHEXLEN  ((CRC32LEN << 1) | 1)
...
int main()
{
   ...
   char results[NUMVECTORS][DIGESTHEXLEN] = {
      "00000000", "43beb7e8", "c2412435", "7f9d1520",
      "bd50274c", "d2e6c21f", "724aa97c"
   };
